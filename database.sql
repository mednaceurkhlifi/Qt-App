--------------------------------------------------------
--  File created - Tuesday-May-02-2023   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table ENCADRANT
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."ENCADRANT" 
   (	"ID_ENCADRANT" NUMBER, 
	"NOM" VARCHAR2(20 BYTE), 
	"PRENOM" VARCHAR2(20 BYTE), 
	"EMAIL" VARCHAR2(20 BYTE), 
	"SPECIALITE" VARCHAR2(20 BYTE), 
	"ETABLISSEMENT" VARCHAR2(20 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."PUBLICATION" 
   (	"ID_PUBLICATION" NUMBER, 
	"NBPUB" NUMBER, 
	"PROPRIETE" VARCHAR2(20 BYTE), 
...
SET DEFINE OFF;
Insert into SYSTEM.ARDUINO (TEMP,STATUS) values ('25','alarm off');
Insert into SYSTEM.ARDUINO (TEMP,STATUS) values ('23',null);
Insert into SYSTEM.ARDUINO (TEMP,STATUS) values ('27','alarm off');
Insert into SYSTEM.ARDUINO (TEMP,STATUS) values ('29','alarm off');
...
SET DEFINE OFF;
Insert into SYSTEM.EMPLOYE (ID,NOM,USERNAME,PASSWORD) values (1,'salah','salah','1234');
Insert into SYSTEM.EMPLOYE (ID,NOM,USERNAME,PASSWORD) values (3,'mohamed','med','1234');
Insert into SYSTEM.EMPLOYE (ID,NOM,USERNAME,PASSWORD) values (3,'ines','ines','1234');
REM INSERTING into SYSTEM.ENCADRANT
SET DEFINE OFF;
Insert into SYSTEM.ENCADRANT (ID_ENCADRANT,NOM,PRENOM,EMAIL,SPECIALITE,ETABLISSEMENT) values (6,'cv','bv','kk','business','gg');
Insert into SYSTEM.ENCADRANT (ID_ENCADRANT,NOM,PRENOM,EMAIL,SPECIALITE,ETABLISSEMENT) values (1,'rt','ff','ggb','business','ff');
Insert into SYSTEM.ENCADRANT (ID_ENCADRANT,NOM,PRENOM,EMAIL,SPECIALITE,ETABLISSEMENT) values (5,'rt','ff','a','business','ff');
Insert into SYSTEM.ENCADRANT (ID_ENCADRANT,NOM,PRENOM,EMAIL,SPECIALITE,ETABLISSEMENT) values (15,'TEST','TEST','TEST','info','TEST');
REM INSERTING into SYSTEM.ETUDIANT
SET DEFINE OFF;
Insert into SYSTEM.ETUDIANT (ID_ETUDIANT,NOM,PRENOM,EMAIL,SPECIALITE,MENTION) values (17,'test23','test17','tyy25','yyoo17','C');
Insert into SYSTEM.ETUDIANT (ID_ETUDIANT,NOM,PRENOM,EMAIL,SPECIALITE,MENTION) values (26,'ok','test','test','test','B');
Insert into SYSTEM.ETUDIANT (ID_ETUDIANT,NOM,PRENOM,EMAIL,SPECIALITE,MENTION) values (33,'test3','test','test','33','S');
Insert into SYSTEM.ETUDIANT (ID_ETUDIANT,NOM,PRENOM,EMAIL,SPECIALITE,MENTION) values (2,'ali','ali','ali@gmail.com','math','B');
Insert into SYSTEM.ETUDIANT (ID_ETUDIANT,NOM,PRENOM,EMAIL,SPECIALITE,MENTION) values (43,'aymen','abdallah','aymen@esprit.tn','info','A');
Insert into SYSTEM.ETUDIANT (ID_ETUDIANT,NOM,PRENOM,EMAIL,SPECIALITE,MENTION) values (9999,'integ','test','test','integ','integ');
Insert into SYSTEM.ETUDIANT (ID_ETUDIANT,NOM,PRENOM,EMAIL,SPECIALITE,MENTION) values (4,'etudiant integ','prenom ','email4@email.com','specialitetest','A');
Insert into SYSTEM.ETUDIANT (ID_ETUDIANT,NOM,PRENOM,EMAIL,SPECIALITE,MENTION) values (1,'integration','integration','integ','integ','integ');
...
SET DEFINE OFF;
Insert into SYSTEM.MATERIEL (ID_MATERIEL,NOM,QUANTITE,DISPONIBILITE,PRIX) values (15,'test','0','non','0');
Insert into SYSTEM.MATERIEL (ID_MATERIEL,NOM,QUANTITE,DISPONIBILITE,PRIX) values (985,'inesssss','15','non','88888');
Insert into SYSTEM.MATERIEL (ID_MATERIEL,NOM,QUANTITE,DISPONIBILITE,PRIX) values (23,'ijure','0','non','4');
Insert into SYSTEM.MATERIEL (ID_MATERIEL,NOM,QUANTITE,DISPONIBILITE,PRIX) values (71,'ines','0','non','0');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.PUBLICATION
SET DEFINE OFF;
Insert into SYSTEM.PUBLICATION (ID_PUBLICATION,NBPUB,PROPRIETE,DESCRIPTION,DATE_DE_PUBLICATION,SUJET) values (23,15,'mmmm','test',to_date('01-JAN-00','DD-MON-RR'),'test');
Insert into SYSTEM.PUBLICATION (ID_PUBLICATION,NBPUB,PROPRIETE,DESCRIPTION,DATE_DE_PUBLICATION,SUJET) values (1,99,'ines','ffff',to_date('01-JAN-05','DD-MON-RR'),'lateriel');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.SPONSOR
SET DEFINE OFF;
Insert into SYSTEM.SPONSOR (ID_SPONSOR,NOM,MONTANT,DUREE,CONTACT) values (2,'ahmed','12','0','15');
Insert into SYSTEM.SPONSOR (ID_SPONSOR,NOM,MONTANT,DUREE,CONTACT) values (1,'200','2000','300','0');
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PUBLICATION" MODIFY ("ID_PUBLICATION" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."TABLE1" MODIFY ("TEST" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MATERIEL" MODIFY ("ID_MATERIEL" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ENCADRANT" MODIFY ("ID_ENCADRANT" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."SPONSOR" MODIFY ("ID_SPONSOR" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ETUDIANT" MODIFY ("ID_ETUDIANT" NOT NULL ENABLE);
--------------------------------------------------------
