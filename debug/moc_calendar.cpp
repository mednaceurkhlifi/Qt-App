...
#include "../../2a3-2a3-smart-rdi-center-integration_3/2a3-2a3-smart-rdi-center-integration/calendar.h"
...
QT_MOC_LITERAL(1, 9, 18), // "onDayDoubleClicked"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 4) // "date"

    },
    "Calendar\0onDayDoubleClicked\0\0date"
};
...
void Calendar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onDayDoubleClicked((*reinterpret_cast< const QDate(*)>(_a[1]))); break;
        default: ;
        }
    }
}
