...
""));
        ...
        QIcon icon;
        QString iconThemeName = QStringLiteral("aligner");
        ...
        label_6->setGeometry(QRect(60, 10, 31, 31));
        ...
        mediaplayer->setGeometry(QRect(644, 12, 41, 31));
        ...
        popupLabel->setGeometry(QRect(30, 10, 201, 51));
        label_12->raise();
        notif->raise();
        mediaplayer->raise();
        frame->raise();
        ...
        frame_2->setGeometry(QRect(0, 76, 1061, 631));
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral("icons/file-upload.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        pdf->setGeometry(QRect(710, 550, 41, 31));
        ...
        table_materiel->setGeometry(QRect(20, 130, 561, 441));
        ...
        search->setGeometry(QRect(200, 20, 31, 23));
        ...
        statistics->setGeometry(QRect(700, 490, 51, 41));
        label_15->raise();
        rechercher->raise();
        label_2->raise();
        label_13->raise();
        ...
        mainbody->raise();
        sidemenu->raise();
        rightsidemenu = new QFrame(widget);
        rightsidemenu->setObjectName(QStringLiteral("rightsidemenu"));
        rightsidemenu->setGeometry(QRect(960, 80, 211, 611));
    ...
    void retranslateUi(QWidget *widget)
    {
        ...
        pushButton_6->setText(QApplication::translate("widget", "  recherche", Q_NULLPTR));
